  ...
  <div class="description-popup-wrapper">
    ...
    <div class="market-popup-wrapper">
      <ul class="market-popup-list">
        <li class="list">
          <a href="${buy_links[0].url}"><img src="${amazonFoto}" alt="amazon" width="62" /></a>
        </li>
        <li class="list">
          <a href="${buy_links[1].url}"><img src="${applebookFoto}" alt="applebook" width="32" /></a>
        </li>
        <li class="list">
          <a href="${buy_links[2].url}"><img src="${bookshopFoto}" alt="bookshop" width="38" /></a>
        </li>
      </ul>
    </div>
  </div>`;
